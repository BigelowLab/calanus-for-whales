...
For each model, the logged actual abundance of ``r params$species`` was plotted against the predicted probability of suitability.  This was done for both the training data (``r params$biomod_dataset``) and independent data (CPR). Error bars indicate the variance.  The plots are color coded by region, either Mid-Atlantic Bight (MAB), George's Bank (GBK), or the Gulf of Maine (GOM).
...
**Figure 21.** Actual logged abundance versus predicted probability of suitability for ``r params$species`` for a.) all 12 months and b.) all years.
...
**Figure 22.** Actual logged abundance versus predicted probability of suitability for ``r params$species`` for a.) all 12 months and b.) all years.
...
**Figure 23.** Actual logged abundance versus predicted probability of suitability for ``r params$species`` for a.) all 12 months and b.) all years.
...
**Figure 24.** Actual logged abundance versus predicted probability of suitability for ``r params$species`` for a.) all 12 months and b.) all years.
...
**Figure 25.** Plots of actual abundance vs. predicted probability of exceeding the feeding threshold in different regions.
...
**Figure 26.** Plots of actual abundance vs. predicted probability of exceeding the feeding threshold in different regions.
...
**Figure 27.** Plots of actual abundance vs. predicted probability of exceeding the feeding threshold in different regions.
...
**Figure 28.** Plots of actual abundance vs. predicted probability of exceeding the feeding threshold in different regions.
...
**Figure 29.** Plots of actual abundance vs. predicted probability of exceeding the feeding threshold in different regions.
...
**Figure 30.** Plots of actual abundance vs. predicted probability of exceeding the feeding threshold in different regions.
...
**Figure 31.** Plots of actual abundance vs. predicted probability of exceeding the feeding threshold in different regions.
...
**Figure 32.** Plots of actual abundance vs. predicted probability of exceeding the feeding threshold in different regions.
...
**Figure 33.** Plots of actual binary exceeding of the feeding threshold  vs. predicted probability of exceeding the feeding threshold in different regions.
...
**Figure 34.** Plots of actual binary exceeding of the feeding threshold  vs. predicted probability of exceeding the feeding threshold in different regions.
...
**Figure 35.** Plots of actual binary exceeding of the feeding threshold  vs. predicted probability of exceeding the feeding threshold in different regions.
...
**Figure 36.** Plots of actual binary exceeding of the feeding threshold  vs. predicted probability of exceeding the feeding threshold in different regions.
...
**Figure 37.** Plots of actual binary exceeding of the feeding threshold  vs. predicted probability of exceeding the feeding threshold in different regions.
...
**Figure 38.** Plots of actual binary exceeding of the feeding threshold  vs. predicted probability of exceeding the feeding threshold in different regions.
...
**Figure 39.** Plots of actual binary exceeding of the feeding threshold  vs. predicted probability of exceeding the feeding threshold in different regions.
...
**Figure 40.** Plots of actual binary exceeding of the feeding threshold  vs. predicted probability of exceeding the feeding threshold in different regions.
