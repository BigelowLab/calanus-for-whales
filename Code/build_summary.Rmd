...
For the mgcv GAM and gbm BRT models, the logged actual abundance of ``r params$species`` was plotted against the logged predicted abundance.
...
**Figure 20.** Actual logged abundance versus logged predicted abundance for ``r params$species`` for all 12 months.
...
**Figure 21.** Actual logged abundance versus logged predicted abundance for ``r params$species`` for all 12 months.
...
**Figure 22.** Actual logged abundance versus predicted probability of suitability for ``r params$species`` for all 12 months.
