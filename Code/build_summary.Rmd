...
For the biomod models, the logged actual abundance of ``r params$species`` was plotted against the predicted probability of suitability.  Above the threshold of ``r params$threshold``, the probability of suitability tends to increase.  Below the threshold, the probability of suitability tends to be zero.  
...
**Figure 15.** Actual logged abundance versus predicted probability of suitability for ``r params$species`` for all 12 months.
