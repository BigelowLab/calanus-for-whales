...
**Figure 3.** Ensemble projections for the month of April over ``r params$years``.
...
**Figure 4.** Ensemble projections for the month of May over ``r params$years``.
...
**Figure 5.** Ensemble projections for the month of June over ``r params$years``.
...
**Figure 6.** Ensemble projections for the month of August over ``r params$years``.
...
**Figure 7.** Ensemble projections for the month of September over ``r params$years``.
...
**Figure 8.** Biomod ensemble evaluations on a monthly time scale using a.) AUC and b.) TSS
...
**Figure 9.** Biomod GAM evaluations on a monthly time scale using a.) AUC and b.) TSS
...
**Figure 9.** Biomod BRT evaluations on a monthly time scale using a.) AUC and b.) TSS
...
**Figure 9.** Biomod RF evaluations on a monthly time scale using a.) AUC and b.) TSS
...
# Load evals
var_cont <- readPNG(file.path(fp, "gam_var_contribution.png"))
...
# Load evals
var_cont <- readPNG(file.path(fp, "brt_var_contribution.png"))
...
# Load evals
var_cont <- readPNG(file.path(fp, "rf_var_contribution.png"))
...
**Figure 10.** Actual logged abundance versus predicted probability of suitability for ``r params$species`` for all 12 months.
...
**Figure 11.** Monthly climatological GAM projections.  The climatology was created by averaging together the projections from 2000 to 2017.
...
**Figure 12.** Model evaluations on a monthly time scale using a.) AIC, b.) RMSE, and c.) R2.
...
**Figure 13.** Climatological abundance values averaged over three regions, a.) the Mid Atlantic Bight, b.) George's Bank, and c.) the Gulf of Maine.  The predicted values come from the projections.
...
**Figure 14.** Abundance values averaged monthly over three regions, a.) the Mid Atlantic Bight, b.) George's Bank, and c.) the Gulf of Maine.  The predicted values come from the projections.
...
**Figure 15.** Abundance values averaged annually over three regions, a.) the Mid Atlantic Bight, b.) George's Bank, and c.) the Gulf of Maine.  The predicted values come from the projections.
...
**Figure 16.** Actual logged abundance versus logged predicted abundance for ``r params$species`` for all 12 months.
...
**Figure 17.** Monthly climatological BRT projections.  The climatology was created by averaging together the projections from 2000 to 2017.
...
**Figure 18.** Model evaluations on a monthly time scale using a.) RMSE and b.) R2.
...
**Figure 19.** Climatological abundance values averaged over three regions, a.) the Mid Atlantic Bight, b.) George's Bank, and c.) the Gulf of Maine.  The predicted values come from the projections.
...
**Figure 20.** Abundance values averaged monthly over three regions, a.) the Mid Atlantic Bight, b.) George's Bank, and c.) the Gulf of Maine.  The predicted values come from the projections.
...
**Figure 21.** Abundance values averaged annually over three regions, a.) the Mid Atlantic Bight, b.) George's Bank, and c.) the Gulf of Maine.  The predicted values come from the projections.
...
**Figure 22.** Actual logged abundance versus logged predicted abundance for ``r params$species`` for all 12 months.
